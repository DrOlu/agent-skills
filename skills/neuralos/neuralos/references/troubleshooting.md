...
§1 `ModuleNotFoundError: No module named 'neuralOS'`
...
try:
    ...
    import os, sys
    fw = "/path/to/python-that-has-neuralOS"
...
- Running with an interpreter that lacks neuralOS → §1 (traceback on stderr).
