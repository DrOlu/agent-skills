#!/usr/bin/env python3
"""rmagent-windows grain wrapper (facade of rmagent-so). Engine in rmagent-core.

Identity ALLOWED only. ask() refuses actuate. Cap 32 KB. A hole is an answer.
"""
