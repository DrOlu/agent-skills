...
$psp=@()
try{ $psp=@(Get-WinEvent -FilterHashtable @{LogName='Security';Id=4688;StartTime=$since}|Where-Object{MT $_}|Select-Object -First 20|ForEach-Object{ [pscustomobject]@{t=$_.TimeCreated.ToString('o');u=$_.Properties[1].Value;p=$_.Properties[5].Value} }) }catch{}
